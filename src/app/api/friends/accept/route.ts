...
export async function POST(req: Request) {
    try {
        ...
        await Promise.all([
            ...
            db.sadd(`user:${session.user.id}:friends`, idToAdd), // my friend
            db.sadd(`user:${idToAdd}:friends`, session.user.id), // your friend
        ...
        // await db.sadd(`user:${session.user.id}:friends`, idToAdd) // my friend
        // await db.sadd(`user:${idToAdd}:friends`, session.user.id) // your friend
        // // await db.srem(`user:${idToAdd}:incoming_friend_requests`, session.user.id)
